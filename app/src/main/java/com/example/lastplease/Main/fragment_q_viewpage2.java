...
public class fragment_q_viewpage2 extends Fragment {
    ...
    Query query;
    public fragment_q_viewpage2(){}

    public static fragment_q_viewpage2 newinstance(){
        fragment_q_viewpage2 fragment_q_viewpage2 = new fragment_q_viewpage2();
        return fragment_q_viewpage2;
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_q_viewpage2, container, false);
    ...
    public void onStart() {
        ...
        final FirestoreRecyclerAdapter<Feed, fragment_viewpage2.FeedViewHolder> feedAdapter=
                new FirestoreRecyclerAdapter<Feed, fragment_viewpage2.FeedViewHolder>(options){
                    @Override
                    protected void onBindViewHolder(@NonNull final fragment_viewpage2.FeedViewHolder holder, final int position, @NonNull Feed model) {
                    ...
                    @NonNull
                    @Override
                    public fragment_viewpage2.FeedViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
